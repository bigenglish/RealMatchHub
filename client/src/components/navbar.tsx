      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-6">
            ...
            <Link href="/idx-explorer" className="text-sm font-medium bg-olive-50 text-olive-800 px-3 py-1 rounded-md border border-olive-200 hover:bg-olive-100 whitespace-nowrap flex items-center">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4">
            ...
            <Link href="/idx-explorer" className="block px-2 py-2 bg-olive-50 text-olive-800 hover:bg-olive-100 rounded flex items-center">
